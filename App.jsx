  ...
  return (
    <SafeAreaView edges={['top']} style={styles.headerContainer}>
      ...
      <View style={styles.headerRight}>
        ...
        {/* Custom Burger Menu Trigger with Lucide Menu Icon */}
        <TouchableOpacity 
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        // MAPPING LUCIDE ICONS TO EVERY SCREEN TAB
        tabBarIcon: ({ color, size }) => {
          const iconSize = size ? size : 22;
          
          if (route.name === 'Feed') {
            return <Home color={color} size={iconSize} strokeWidth={2} />;
          } else if (route.name === 'MyHub') {
            return <Users color={color} size={iconSize} strokeWidth={2} />;
          } else if (route.name === 'Jobs') {
            return <Briefcase color={color} size={iconSize} strokeWidth={2} />;
    ...
    >
      ...
      <Tab.Screen name="MyHub" component={MyHubScreen} options={{ tabBarLabel: 'My Hub' }} />
      ...
      <Tab.Screen name="Articles" component={ArticlesScreen} options={{ tabBarLabel: 'Articles' }} />
  ...
  return (
    <Drawer.Navigator
      screenOptions={({ navigation }) => ({
        header: () => <CustomHeader navigation={navigation} userName="Abdullah Azalea" balance="35" />,
...
/* ==========================================
   APP CONTAINER CONTAINER MAIN ROOT
   ========================================== */
...
// Keep the styling sheet standard as before...
